...
def _resolve_named_custom_runtime(
    *,
    ...
    result = {
        "provider": "custom",
        "api_mode": (
            _provider_profile_model_api_mode(
                str(custom_provider.get("name", requested_provider) or requested_provider),
                target_model or custom_provider.get("model") or _get_model_config().get("default"),
            )
